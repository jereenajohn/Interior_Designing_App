...
public class User_view_room_designs extends Activity implements JsonResponse, AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_view_room_designs);
        ...
        JR.json_response=(JsonResponse)User_view_room_designs.this;
        String q="User_view_room_designs/";
        JR.execute(q);
    }
...
//                    details[i]="photo : "+photo[i]+"\nname : "+name[i]+"\nmaterial : "+material[i]+"\ndes : "+des[i]+"\ncolor : "+color[i]+"\nprice : "+price[i];
                ...
                Custimage ci=new Custimage(User_view_room_designs.this, photo,name,material,des,color,price);
...
//                l1.setAdapter(new ArrayAdapter<String>(getApplicationContext(), android.R.layout.simple_list_item_1,details));
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(User_view_room_designs.this);
