...
public class Custimage extends ArrayAdapter<String>  {
	...
	private String[] photo,name,material,des,color,price;
	
	
	 public Custimage(Activity context, String[] photo,String[] name,String[] material,String[] des,String[] color,String[] price) {
	        //constructor of this class to get the values from main_activity_class

	        super(context, R.layout.cust_images, photo);
	    ...
	    public View getView(int position, View convertView, ViewGroup parent) {
	        ...
	        t1.setText("material : "+ material[position]);
	        t2.setText("Description : "+des[position]);
	        t3.setText("color : "+color[position]);
	        t4.setText("price : "+price[position]);
